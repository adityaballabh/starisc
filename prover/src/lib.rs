...
// bit decomp for res/lt/mod diff [20, 83].
pub(crate) const RANGE_BITS_BASE: usize = NUM_REGISTERS + NUM_WITNESS_COLS;
// bit decomp for wrapping carries/borrows/high limbs [84, 147].
...
// constraints: regs [0,15], witness [16,19], assert_eq/mod [20,21], range/lt/wrap [22,...]
